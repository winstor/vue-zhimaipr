<template>
		<div class="app-container">
				<div class="box-header">
						<grid-filter v-model="listQuery" :data="filterData" @search="handleFilter"></grid-filter>
				...
				<madel v-model="madelRow" :data.sync="madelData" :visible.sync="dialogVisible" @confirm="confirm"></madel>
		</div>
</template>
...
<script>
    ...
    import GridTable from '@/components/Template/Grid/GridTable'
    import GridFilter from '@/components/Template/Grid/GridFilter'
    ...
    export default {
        ...
        data() {
            return {
                ...
                dialogVisible: false,
                dialogType: 'create',
                madelRow: {title: 'tt', mobile: '18037773472'}
            }
        },
        created() {
            this.getList()
