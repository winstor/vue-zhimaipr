...
<script>
    ...
    import BatchMore from './../components/Tool/BatchMore'
    import BatchSaleButton from './../components/Tool/BatchSaleButton'
    import CreateButton from './../components/Tool/CreateButton'
    ...
    export default {
        name: "PatentType",
        directives: {waves},
        components: {Pagination,BatchSaleButton,BatchMore,CreateButton},
        data() {
            return {
                base_path: '',
                //查询参数
